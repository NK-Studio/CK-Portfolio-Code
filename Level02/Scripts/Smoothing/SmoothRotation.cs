...
namespace Smoothing
{
	...
	public class SmoothRotation : MonoBehaviour {
		...
		/// <param name="_smoothSpeed"></param>
		/// <returns></returns>
		private Quaternion Smooth(Quaternion currentRotation, Quaternion targetRotation, float _smoothSpeed)
		{
			...
			return Quaternion.Slerp (currentRotation, targetRotation, Time.deltaTime * _smoothSpeed);
		}
