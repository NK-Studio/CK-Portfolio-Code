...
{
    [CustomEditor(typeof(StartGameNode))]
    public class StartGameNodeEditor : FlowNodeEditor
    {
        public override IEnumerable<Texture2D> nodeIconTextures =>
            EditorSpriteSheets.Nody.Icons.CustomNode; //custom animated icon
        ...
        {
            base.FindProperties();
            propertyTargetValue = serializedObject.FindProperty(nameof(StartGameNode.CheckPoint));
        }
        ...
        protected override void InitializeEditor()
        {
            ...
            componentHeader.SetComponentNameText(ObjectNames.NicifyVariableName(nameof(StartGameNode))); //node name
            targetValuePropertyField = DesignUtils.NewPropertyField(propertyTargetValue).SetStyleMarginLeft(12);

            targetValueField =
                FluidField.Get()
                    .SetStyleFlexGrow(1)
                    .SetLabelText("Check Point")
