...
{
    public class WaitTimeNodeView : FlowNodeView
    {
        public override Type nodeType => typeof(WaitTimeNode);
        ...
        public WaitTimeNodeView(FlowGraphView graphView, FlowNode node) : base(graphView, node)
        {
