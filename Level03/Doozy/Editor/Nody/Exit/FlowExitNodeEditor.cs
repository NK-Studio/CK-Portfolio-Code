...
{
    [CustomEditor(typeof(FlowExit))]
    public class FlowExitNodeEditor : FlowNodeEditor
    {
        ...
        protected override void InitializeEditor()
        {
            ...
            componentHeader.SetComponentNameText(ObjectNames.NicifyVariableName(nameof(FlowExit))); //node name

            // --- Icon ---
            componentHeader.SetIcon(EditorSpriteSheets.Nody.Icons.ExitNode); //custom animated icon
