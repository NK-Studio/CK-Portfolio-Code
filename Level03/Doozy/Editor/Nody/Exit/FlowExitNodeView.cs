...
{
    public class FlowExitNodeView : FlowNodeView
    {
        public override Type nodeType => typeof(FlowExit);
        ...
        public FlowExitNodeView(FlowGraphView graphView, FlowNode node) : base(graphView, node)
        {
