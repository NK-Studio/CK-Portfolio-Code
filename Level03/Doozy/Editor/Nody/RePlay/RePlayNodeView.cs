...
{
    public class RePlayNodeView : FlowNodeView
    {
        public override Type nodeType => typeof(RePlayNode);
        ...
        public RePlayNodeView(FlowGraphView graphView, FlowNode node) : base(graphView, node)
        {
