...
{
    [CustomEditor(typeof(RePlayNode))]
    public class RePlayNodeEditor : FlowNodeEditor
    {
        ...
        protected override void InitializeEditor()
        {
            ...
            componentHeader.SetComponentNameText(ObjectNames.NicifyVariableName(nameof(RePlayNode))); //node name
