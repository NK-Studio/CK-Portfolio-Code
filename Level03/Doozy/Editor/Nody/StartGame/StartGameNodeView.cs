...
{
    public class StartGameNodeView : FlowNodeView
    {
        public override Type nodeType => typeof(StartGameNode);
        ...
        public StartGameNodeView(FlowGraphView graphView, FlowNode node) : base(graphView, node)
        {
