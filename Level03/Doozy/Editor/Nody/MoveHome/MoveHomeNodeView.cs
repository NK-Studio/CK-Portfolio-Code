...
{
    public class MoveHomeNodeView : FlowNodeView
    {
        public override Type nodeType => typeof(MoveHomeNode);
        ...
        public MoveHomeNodeView(FlowGraphView graphView, FlowNode node) : base(graphView, node)
        {
